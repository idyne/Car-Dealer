...
public class TuningLoader : MonoBehaviour {
	...
	void Start(){
		//------------------------------------------------------------------------------------------------------
		//load all selected parts
		FrontBumperSelected=PlayerPrefs.GetInt(CarNumber+ "FrontBumperSelected");
		RearBumperSelected=PlayerPrefs.GetInt(CarNumber+"RearBumperSelected");
		SideSkirtSelected=PlayerPrefs.GetInt(CarNumber+"SideSkirtSelected");
		HoodSelected=PlayerPrefs.GetInt(CarNumber+"HoodSelected");
		RoofSelected=PlayerPrefs.GetInt(CarNumber+"RoofSelected");
		SpoilerSelected=PlayerPrefs.GetInt(CarNumber+"SpoilerSelected");
		WheelSelected=PlayerPrefs.GetInt(CarNumber+"WheelSelected");
